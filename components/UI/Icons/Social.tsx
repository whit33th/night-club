...
export function TelegramIcon({ size = 22, className = "", ...props }: Props) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M9.999 15.2 9.7 19.4c.45 0 .64-.2.87-.44l2.08-1.98 4.31 3.15c.79.44 1.36.21 1.57-.73l2.85-13.34c.25-1.12-.4-1.56-1.19-1.29L2.64 9.75c-1.1.43-1.08 1.05-.19 1.33l4.33 1.35 10.07-6.3c.47-.29.89-.13.54.16l-8.16 7.91Z" />
    </svg>
  );
}
export function LinktreeIcon({ size = 22, className = "", ...props }: Props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
